...
| --- | --- |
| MSV-01 | `MSV-01 and MSV-02 exclude Test Cases inside a collapsed suite from the layout cost`; `MSV-01 ignores a filtered Test Case and preserves the remaining visible layout` |
...
| MSV-04 | `MSV-02 through MSV-05 count suite headers as rows and keep an equally good layout unchanged` |
