...
describe("TestCaseColumn", () => {
  ...
  it("allows a populated leaf suite to toggle its persisted collapsed state", () => {
    ...
    expect(
      leafToggle.querySelector(".relations-view-suite-disclosure-icon")?.getAttribute("data-direction")
    ).toBe("right");
  ...
  it("invokes explorer controls and exposes keyboard tree navigation", () => {
    ...
    expect(
      treeButtons[0].querySelector(".relations-view-suite-disclosure-icon")?.getAttribute("data-direction")
    ).toBe("down");
    treeButtons[0].focus();
