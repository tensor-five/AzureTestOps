 ...
 * one-time bootstrap (when no ADO context preference exists) and as the edit
 * affordance reachable from the Set-Manager banner.
 *
  ...
  return (
    <form className="set-editor" onSubmit={handleSubmit}>
      <p className="set-editor-help">
        ...
        The values are stored locally in your Azure TestOps preferences.
      </p>
      {defaultsHint ? (
