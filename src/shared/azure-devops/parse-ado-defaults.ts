 ...
 * up with what `~/.azure-testops/ado-context.json` stores. Missing keys
 * collapse to empty strings rather than `undefined` so callers can compare
 * directly without null-handling everywhere.
 */
